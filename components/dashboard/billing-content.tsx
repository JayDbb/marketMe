...
export function BillingContent() {
  ...
  return (
    <motion.div variants={itemVariants} className="space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button 
            ...
            className="h-10 bg-transparent border-white/10 text-white hover:bg-white/5 font-medium rounded-xl"
          >
            View all plans
          </Button>
          <Button 
            onClick={() => setIsUpgradeModalOpen(true)}
            className="h-10 bg-white text-zinc-950 hover:bg-white/90 font-bold rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all"
          >
            Manage plan
          </Button>
          <Button 
      ...
      <Card className="bg-white/4 backdrop-blur-xl border-white/8 text-white shadow-xl rounded-2xl overflow-hidden">
        <CardContent className="p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-white/40">For those starting out on socials.</p>
          </div>
          <div className="text-left sm:text-right">
            <div className="text-2xl font-bold text-white mb-1">$0 <span className="text-sm font-normal text-white/40">/ month</span></div>
            <p className="text-xs text-white/30">No renewal on this plan</p>
          </div>
        </CardContent>
      </Card>
      ...
      {/* Usage Section */}
      <div>
        <h4 className="text-base font-bold text-white mb-4 mt-8">Usage</h4>
        <Card className="bg-white/4 backdrop-blur-xl border-white/8 text-white shadow-xl rounded-2xl overflow-hidden">
          <CardContent className="p-0 divide-y divide-white/5">
            ...
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-xs text-white/40">Workspaces allow you to split your work into groups (by client, by channels, etc).</p>
              </div>
              <div className="w-full md:w-[300px]">
                ...
                <Progress value={100} className="h-3 bg-white/10 [&>div]:bg-white/30" />
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-xs text-white/40">Total number of team members you can invite across all workspaces.</p>
              </div>
              <div className="w-full md:w-[300px]">
                <div className="flex justify-between text-xs text-white/50 mb-2">
            ...
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-xs text-white/40">Total number of unique social profiles you can connect across all workspaces.</p>
              </div>
              <div className="w-full md:w-[300px]">
                <div className="flex justify-between text-xs text-white/50 mb-2">
                ...
                <Progress value={0} className="h-3 bg-white/10 [&>div]:bg-blue-500" />
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-xs text-white/40">Used for AI generation, automation runs, and publishing actions. Resets monthly.</p>
              </div>
              <div className="w-full md:w-[300px]">
                <div className="flex justify-between text-xs text-white/50 mb-2">
