...
export function GoogleAuthButton() {
  ...
  return (
    <Button
      ...
      className="w-full h-12 bg-white hover:bg-zinc-100 text-zinc-950 font-semibold rounded-xl border-0 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
    >
      {isLoading ? (
