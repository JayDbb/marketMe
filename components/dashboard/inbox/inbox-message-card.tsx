...
export function InboxConversationCard({
  ...
  const preview =
    ...
    'No messages yet'
  const receivedAt =
    conversation.latestMessage?.receivedAt || conversation.updatedAt
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {isUnread && (
          <span className="min-w-5 h-5 px-1 rounded-full bg-blue-500 text-white text-[10px] font-bold flex items-center justify-center shrink-0 mt-1">
...
export function InboxConversationColumn({
  title,
  icon: Icon,
  conversations,
  emptyTitle,
